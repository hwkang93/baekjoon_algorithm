...
public class Level14_7 {
    ...
    public static void calculation(int at, int value, int[] operator) {
        if(at == n) {
            if(value < min) {
                min = value;
            }
        ...
        for(int i=0; i<operator.length; i++) {
            ...
            //더하기
            if(i == 0) {
                calculation(at+1, value + arr[at], operator);
            }
            //빼기
            else if(i == 1) {
                calculation(at+1, value - arr[at], operator);
