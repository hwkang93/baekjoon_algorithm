...
/**
 *  10250. ACM호텔
 *      ACM 호텔 매니저 지우는 손님이 도착하는 대로 빈 방을 배정하고 있다. 고객 설문조사에 따르면
 *      손님들은 호텔 정문으로부터 걸어서 가장 짧은 거리에 있는 방을 선호한다고 한다. 여러분은 지우를 도와 줄 프로그램을 작성하고자 한다.
 ...
 *      그리고 엘리베이터는 가장 왼쪽에 있다고 가정하자. 이런 형태의 호텔을 H × W 형태 호텔이라고 부른다.
...
public class Level8_5 {
    public static void main(String[] args) {
        ...
        for(int i=0; i<t; i++) {
            ...
            System.out.println(first*100 + end);
        }
    }
}
